...
type AuthServiceClient interface {
	...
	AdminRegister(ctx context.Context, in *AdminRegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error)
...
func (c *authServiceClient) AdminRegister(ctx context.Context, in *AdminRegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterResponse)
...
type AuthServiceServer interface {
	...
	AdminRegister(context.Context, *AdminRegisterRequest) (*RegisterResponse, error)
...
func (UnimplementedAuthServiceServer) AdminRegister(context.Context, *AdminRegisterRequest) (*RegisterResponse, error) {
