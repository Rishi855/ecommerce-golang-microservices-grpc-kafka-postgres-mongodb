...
const file_internal_proto_product_proto_rawDesc = "" +
	...
	"\x05stock\x18\x02 \x01(\x03R\x05stock\x12\x0e\n" +
	...
	"\rDecreateStock\x12\x1d.product.DecreaseStockRequest\x1a\x1e.product.DecreaseStockResponseB\x12Z\x10./internal/protob\x06proto3"
...
var file_internal_proto_product_proto_depIdxs = []int32{
	...
	5, // 3: product.ProductService.DecreateStock:input_type -> product.DecreaseStockRequest
	...
	6, // 6: product.ProductService.DecreateStock:output_type -> product.DecreaseStockResponse
