...
func (x *DecreaseStockRequest) Reset() {
	*x = DecreaseStockRequest{}
	mi := &file_internal_proto_product_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DecreaseStockRequest) Descriptor() ([]byte, []int) {
	return file_internal_proto_product_proto_rawDescGZIP(), []int{7}
}
...
func (x *DecreaseStockResponse) Reset() {
	*x = DecreaseStockResponse{}
	mi := &file_internal_proto_product_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DecreaseStockResponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_product_proto_rawDescGZIP(), []int{8}
}
...
const file_internal_proto_product_proto_rawDesc = "" +
	"\n" +
	"\x1cinternal/proto/product.proto\x12\aproduct\"V\n" +
	...
	"\rDecreaseStock\x12\x1d.product.DecreaseStockRequest\x1a\x1e.product.DecreaseStockResponseB\x12Z\x10./internal/protob\x06proto3"
...
var file_internal_proto_product_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
